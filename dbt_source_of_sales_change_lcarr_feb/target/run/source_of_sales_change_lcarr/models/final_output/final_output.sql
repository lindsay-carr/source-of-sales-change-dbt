  ...
  create view "cfa"."public"."final_output__dbt_tmp" as (
    with twentytwo as (
select *
from public.lc_big_join_final1 
...
a.quarter,a.region_name,a.service_team_name,a.dma_name,
