  ...
  b.price_index, d.previous_year_monthend_date
  from "cfa"."public"."lcarr_sosx_agg__same_store_all_store" a
  ...
  inner join "cfa"."public"."lcarr_sosx_agg__distinct_calcs" e
